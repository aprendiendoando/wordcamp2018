          ...
          <h3 class="title title--section-secundary text text-center">Services</h3>
            ...
            <section class="photostyles__item text margin--big text-center">
                <article class="photostyles__box js-photostyles--left">
                  <span class="isa-graduation"></span>
                  <h3 class="photostyles--title">Aerials</h3>
                  <p class="photostyles--information">
                    Aerial photography is the taking of photographs of the ground from an elevated/direct-down position
                  </p>
                  <a class="btn btn--primary" href="services-aerials.html">
                    Read More
                  </a>
                </article> <!-- Services one -->
                <article class="photostyles__box js-photostyles--left">
                  <span class="isa-photo-camera"></span>
                  <h3 class="photostyles--title">Europe</h3>
                  <p class="photostyles--information">
                    Aerial photography is the taking of photographs of the ground from an elevated/direct-down position
                  </p>
                  <a class="btn btn--primary" href="services-aerials.html">
                ...
                </article> <!-- Services two -->
                <article class="photostyles__box js-photostyles--right">
                  <span class="isa-wedding"></span>
                  <h3 class="photostyles--title">Pacific</h3>
                  <p class="photostyles--information">
                    Aerial photography is the taking of photographs of the ground from an elevated/direct-down position
                  </p>
                  <a class="btn btn--primary" href="services-aerials.html">
